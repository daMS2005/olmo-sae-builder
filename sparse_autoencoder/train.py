...
# Let this file work both as `python -m ...train` from the repo root and as a
...
import sparse_autoencoder.loss as loss
...
# trainer can train on another activation width without editing code.
...
def load_pre_bias_cache(files: list[Path]) -> torch.Tensor:
    ...
    if not PRE_BIAS_CACHE.exists():
        raise FileNotFoundError(
            ...
            "Run: python -m sparse_autoencoder.compute_pre_bias"
        )
